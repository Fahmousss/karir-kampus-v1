...
>(({ className, children, ...props }, ref) => {
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        "flex bg-black/80 z-10 justify-end items-center p-2",
        className
      )}
      {...props}
      ref={ref}
    ...
    <DialogPortal hostName={portalHost}>
      <DialogOverlay>
        <DialogPrimitive.Content
          ref={ref}
          className={cn(
            "max-w-lg gap-4 border border-border web:cursor-default bg-background p-6 shadow-lg web:duration-200 rounded-3xl",
            open
